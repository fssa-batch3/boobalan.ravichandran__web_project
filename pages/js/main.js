...
const dow_agro_science_details = JSON.parse(
...
// -----tata-rallis----------------------------------
const tata_rallis_details = JSON.parse(
  localStorage.getItem("tata_rallis_details")
);
...
// ----------aries agro-------------------
const aries_agro_details = JSON.parse(
  localStorage.getItem("aries_agro_details")
);
...
// ------------------Bio Insecticides--------------------
const bio_insecticides_details = JSON.parse(
  localStorage.getItem("bio_insecticides_details")
);
...
// ------------------Bio fungicides-----------------
const bio_fungicides_details = JSON.parse(
  localStorage.getItem("bio_fungicides_details")
);
...
// ---------bio nematicides----------------------
const bio_nematicides_details = JSON.parse(
  localStorage.getItem("bio_nematicides_details")
);
...
//  ---------------Bio Vircides--------------------
const bio_vircides_details = JSON.parse(
  localStorage.getItem("bio_vircides_details")
);
...
//  -------------------- Major nurients---------------
const major_nurients_details = JSON.parse(
  localStorage.getItem("major_nurients_details")
);
...
//  -------------Secondary nutrients------------
const secondary_nutrients_details = JSON.parse(
  localStorage.getItem("secondary_nutrients_details")
);
...
//  ------------------Growth Promoters----------------
const growth_promoters_details = JSON.parse(
  localStorage.getItem("growth_promoters_details")
);
...
//  ------------Growth retardancs------------------
const growth_retardants_details = JSON.parse(
  localStorage.getItem("growth_retardants_details")
);
...
//  -----------Organic Fertilizers-------------------------
const organic_fertilizer_details = JSON.parse(
  localStorage.getItem("organic_fertilizer_details")
);
...
//  ------------------------------Bio Fertilizers-----------------
const bio_fertilizers_details = JSON.parse(
  localStorage.getItem("bio_fertilizers_details")
);
...
const anti_stressing_agents_details = JSON.parse(
  localStorage.getItem("anti_stressing_agents_details")
);
...
//  --------------------Micro Nutrients------------------
const micro_nutrients_details = JSON.parse(
  localStorage.getItem("micro_nutrients_details")
);
    ...
    JSON.stringify([
      {
        ...
        productUniqueId: "89e60418-9bd7-4c43-b3cc-2f839b6cef7d",
        timeString: "19:45:30",
        userUniqueId: "9629223357",
        zipCode: "620015",
        state: "Tamil Nadu",
      ...
      },
      {
        ...
        productUniqueId: "3438e3df-f46d-48bf-8b44-b4c7jfd7d3220",
        timeString: "19:45:30",
        userUniqueId: "9629223357",
        zipCode: "620015",
        state: "Tamil Nadu",
